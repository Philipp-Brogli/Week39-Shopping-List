...
public class AddProductDialogFragment extends DialogFragment{
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        final View dialogView = inflater.inflate(R.layout.add, null);
        builder.setView(dialogView)
                ...
                .setPositiveButton("Add", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        EditText editPrize = (EditText) dialogView.findViewById(R.id.prize);
                        int prize = Integer.valueOf(editPrize.getText().toString());
                        // Send the positive button event back to the host activity
                        mListener.onDialogPositiveClick(AddProductDialogFragment.this,product,count, prize);
                    }
                })
